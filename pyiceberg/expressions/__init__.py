...
class Or(BooleanExpression):
    ...
    def __str__(self) -> str:
        ...
        return f"Or(left={str(self.left)}, right={str(self.right)})"
...
class BoundPredicate(Generic[L], Bound, BooleanExpression, ABC):
    ...
    def __str__(self) -> str:
        ...
        return f"BoundPredicate(term={repr(self.term)})"
...
class UnboundPredicate(Generic[L], Unbound[BooleanExpression], BooleanExpression, ABC):
    ...
    def __str__(self) -> str:
        """Return the string representation of the UnboundPredicate class."""
        return f"UnboundPredicate(term={repr(self.term)})"
